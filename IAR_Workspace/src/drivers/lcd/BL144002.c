...
void lcd_io_init()
{
	gpio_init  (PORTC, 0, GPO, 0); //LCD
	gpio_init  (PORTC, 1, GPO, 0); //LCD
	gpio_init  (PORTC, 2, GPO, 0); //LCD
	gpio_init  (PORTC, 3, GPO, 0); //LCD
	gpio_init  (PORTC, 4, GPO, 0); //LCD
	gpio_init  (PORTC, 5, GPO, 0); //LCD
	gpio_init  (PORTC, 6, GPO, 0); //LCD
	gpio_init  (PORTC, 7, GPO, 0); //LCD

	gpio_init  (PORTC, 8, GPO, 0); //LCD
	gpio_init  (PORTC, 9, GPO, 0); //LCD
	gpio_init  (PORTC, 10, GPO, 0); //LCD
	gpio_init  (PORTC, 11, GPO, 0); //LCD
	gpio_init  (PORTC, 12, GPO, 0); //LCD

	gpio_init  (PORTE, 4, GPI, HIGH);  //LCD ok键
	gpio_init  (PORTE, 8, GPI, HIGH);  //LCD 下
	gpio_init  (PORTE, 9, GPI, HIGH);  //LCD 上
	gpio_init  (PORTE, 10, GPI, HIGH); //LCD 右
	gpio_init  (PORTE, 11, GPI, HIGH); //LCD 左
}
...
{	
    ...
    LCD_WR_Data((u8)((site.x+1)>>8));  //高8位 Sx
    LCD_WR_Data((u8)(site.x+1));	  //低8位 Sx
    LCD_WR_Data((u8)(((site.x+1)+size.W-1)>>8)); 
    LCD_WR_Data((u8)((site.x+1)+size.W-1));
